...
public record FileOption(String name, @Nullable Supplier<File> defValue, @Nullable String optCategory) implements ConfigOption<File> {
    ...
    @Override
    public void write(JsonWriter writer, @NotNull File file, ValueSerializationHelper valueSerializationHelper) throws IOException {
        writer.value(file.getAbsolutePath());
    }

    @Override
    public File read(JsonReader reader, ValueSerializationHelper valueSerializationHelper) throws IOException {
